...
---
# Map documentation 
After joining the server, the first thing you need to do is find out where you spawned. Visit the live map at [earthmc.net/map/](https://earthmc.net/map/). Scroll to zoom in.
