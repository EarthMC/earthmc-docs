...
---
# Map documentation 
After joining the server, the first thing you need to do is find out where you spawned. Run command `/map` and get a clickable map link in chat. You can also visit the map by clicking the link [earthmc.net/map/aurora](https://earthmc.net/map/aurora/). Scroll to zoom in.
