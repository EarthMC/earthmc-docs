...
---
# Map documentation 
After joining the server, the first thing you need to do is find out where you spawned. Visit the live map at [earthmc.net/map/aurora](https://earthmc.net/map/aurora). Scroll to zoom in.
