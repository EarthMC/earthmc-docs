...
* **Voting** - Run command `/vote` and click the provided links. You will recieve a gold crate with a random award up to 64 gold ingots after successfully voting for the server.
* **Shops** - Sell your items to other players with the advance shop system. It's a great way to make gold while you're offline.
