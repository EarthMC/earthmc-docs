...
## How to get gold
### Mining
The item-based currency allow players to dig it up straight from the ground. Gold ore is spread evenly accross the world. Gold is equally frequent between y0 to y-64. 
...
### Collecting taxes
Mayors can collect taxes from residents with `/t set tax`, and nation kings can collect taxes from towns `/n set tax`. Taxes are collected once every 24 real-life hours. Read more about taxes [here](https://earthmc.net/docs/town#taxes).
