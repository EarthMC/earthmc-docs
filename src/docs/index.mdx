...
* Longevity - EarthMC has been around since 2016. We're in it for the long run. We run the same map for years. There has been a total of two map resets, one in 2018 and the last one in 2022. The oldest map ("Classic") is still online for players to explore in spectator mode. The "Terra Nova" release is playable, but not featured.
...
* Expensive history - The rich history of the server is being constantly recorded on the [wiki](https://wiki.earthmc.net/).
