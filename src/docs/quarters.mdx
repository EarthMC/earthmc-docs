...
|--------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Apartment    | The default quarter type, which can have an owner who can set trusted users. The owner, trusted users, and those with permissions in the underlying Towny plot can alter this quarter type. All other quarter types inherit and add to this functionality. |
