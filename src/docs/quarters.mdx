...
To create a quarter you need to be the mayor of your town or be a councillor, then you can select two positions using the wand item which is configured to be flint. With two positions selected an outline of a cuboid will appear showing your selection while you are holding the wand item. To proceed type `/q selection add`, if you would like to add more cuboids to your selection repeat selecting two positions and adding them with the same command.
