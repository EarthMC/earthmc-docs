...
You should now type `/t set perm off` to ensure that your town’s default permissions are set so that no residents can interact with anything. Not doing this may cause your town to be griefed or have its items stolen by residents. 
