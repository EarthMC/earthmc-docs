...
2. Creating a town costs 64 gold ingots. Once you have earned the required amount of gold, go to the location where you want the town to be. Then, type `/t new <name>` and accept the prompt. It will create a town with a single chunk.
