...
description: A nation costs 1024 gold. Deposit at least 1024 to the town bank using /t deposit 1024. Only a mayor of a town can create a nation. The mayor's town will become the nation's capital. Create the nation with /n new.
sidebar_position: 8
