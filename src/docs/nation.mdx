...
## Nation basics
As a leader of your nation, you can add allies with `/n ally add <nation>` and invite towns to your nation with `/n add <town>`. You can invite only those towns, which are in proximity of 3000 blocks from your nation's capital.
...
| Command                            | Description                                   |
| ---------------------------------- |:--------------------------------------------- |
| /n \name]                          | Get information of specified nation           |
